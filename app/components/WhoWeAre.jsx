...
const WhoWeAre = () => {
  return (
    ...
    >
      <h1 className="text-white text-[50px] sm:text-[80px] md:text-[120px] italic font-bold absolute top-[10%] md:top-[5%] xl:top-[10%] right-[10%]">
        01
      </h1>
      <div className="w-full flex flex-col items-center justify-center p-2 pb-[50px]">
        ...
        <h1 className="text-white text-3xl sm:text-4xl font-bold z-10 pt-8">
          WHO WE ARE
        </h1>
      </div>
